...
//    }
	...
	private static final String[] WHITE_LIST_URL = 
		{ "/bms/users/register", 
			"/bms/users/login",
			"/bms/users/generate-otp", 
			"/bms/users/verify-otp" };
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		.requestMatchers("/bms/users/register").permitAll()
				.requestMatchers("/bms/users/login").permitAll()
				.requestMatchers("/bms/users/generate-otp").permitAll()
				.requestMatchers("/bms/users/verify-otp").permitAll()
